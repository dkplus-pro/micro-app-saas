...
test('generated tenant source outputs are not tracked in git', async () => {
  const trackedGeneratedFiles = await git(['ls-files', `${generatedPrefix}*`]);
...
test('gitignore keeps tenant generated files and transient build outputs local', async () => {
  ...
  assert.match(gitignore, /apps\/miniapp-template\/dist\//, 'missing miniapp Vite/build output ignore pattern');
