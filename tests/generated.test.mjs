...
const app1Pages = await readJson('dist/tenants/app1/pages.json');
const app2Pages = await readJson('dist/tenants/app2/pages.json');
const app1Manifest = await readJson('dist/tenants/app1/manifest.json');
const app2Manifest = await readJson('dist/tenants/app2/manifest.json');
const app1Routes = await readJson('dist/tenants/app1/generated/route-config.json');
const app2Routes = await readJson('dist/tenants/app2/generated/route-config.json');
const app1Modules = await readJson('dist/tenants/app1/generated/module-registry.json');
const app2Modules = await readJson('dist/tenants/app2/generated/module-registry.json');
const app1Runtime = await readJson('dist/tenants/app1/generated/runtime-config.json');
const app2Runtime = await readJson('dist/tenants/app2/generated/runtime-config.json');
...
assert.deepEqual(app1Runtime.layouts.B.modules.map((module) => module.moduleId), ['a', 'b', 'c', 'd']);
assert.deepEqual(app2Runtime.layouts.B.modules.map((module) => module.moduleId), ['a', 'd', 'c']);
